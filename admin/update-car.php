...
<?php 
    ...
    if(isset($_GET['id']))
    {
        ...
        //Get the Individual Values of Selected Car
        $title = $row2['title'];
                ...
                <td>
                    <?php 
                        ...
                        else
                        {
                            //Image Available
                            ?>
                            <img src="<?php echo SITEURL; ?>images/car/<?php echo $current_image; ?>" width="150px">
                            <?php
                        }
                    ?>
                </td>
            ...
            if(isset($_POST['submit']))
            {
                ...
                if(isset($_FILES['image']['name']))
                {
                    ...
                    if($image_name!="")
                    {
                        ...
                        $image_name = "Car-Name-".rand(0000, 9999).'.'.$ext; //THis will be renamed image

                        //Get the Source Path and Destination Path
                        $src_path = $_FILES['image']['tmp_name']; //Source Path
                        $dest_path = "../images/car/".$image_name; //Destination Path
                ...
                if($res3==true)
                {
                    //Query Exectued and Car Updated
                ...
                else
                {
                    ...
                    $_SESSION['update'] = "Failed to Update Car.";
                    header('location:'.SITEURL.'admin/manage-car.php');
                }
